...
##llamar a la accion de un amigo .gif a una matriz
...
def main():
    ...
    label.pack()
##asignacion de una etiqueta para k sea movil y muestre animaciones

    window.after(1,update,cycle,check,event_number,x)
    window.mainloop()

## make the animations works